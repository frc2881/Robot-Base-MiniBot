...
class RobotCore:
  ...
  def _initTelemetry(self) -> None:
    ...
    SmartDashboard.putNumber("Robot/Drive/Chassis/Length", constants.Subsystems.Drive.ROBOT_LENGTH)
    SmartDashboard.putNumber("Robot/Drive/Chassis/Width", constants.Subsystems.Drive.ROBOT_WIDTH)
